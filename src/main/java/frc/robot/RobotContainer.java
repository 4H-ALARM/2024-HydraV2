...
public class RobotContainer {
    ...
    //private final JoystickButton squareAutoButton = new JoystickButton(driver, XboxController.Button.kX.value);
    ...
    private void configureButtonBindings() {
        ...
        //squareAutoButton.whileTrue(new PathPlannerAuto("Square Auto"));
