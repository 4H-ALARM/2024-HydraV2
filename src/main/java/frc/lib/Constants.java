...
//    public static final shooterConfig shooterconfig = new shooterConfig(53, 54);
//    public static final intakeConfig intakeconfig = new intakeConfig(50, new TunableValue("INTAKE_MOTOR_SPEED" DEBUG, ));
